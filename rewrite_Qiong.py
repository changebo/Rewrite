...
def cnn_model_fn(features, targets, mode, params):
    ...
    dropout = tf.layers.dropout(inputs=pool1, rate=0.4, training=mode == learn.ModeKeys.TRAIN)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_dir', type=str, default='/path_to_model/checkpoints',
    ...
    parser.add_argument('--frame_dir', type=str, default='/path_to_model/frames',
                        help='temporary directory to store font image frames')
    parser.add_argument('--summary_dir', type=str, default='/path_to_model/summary',
                        help='directory for storing data')
    parser.add_argument('--bitmap_dir', type=str, default='/path_to_model/bitmap',
